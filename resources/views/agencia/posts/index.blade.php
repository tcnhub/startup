...
<div class="card mt-4 shadow-sm">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('agencia.posts.create') }}" class="btn btn-primary btn-sm">+ Nuevo Post</a>
    </div>
    <div class="card-body">
            ...
            <table class="table table-hover align-middle">
                ...
                @forelse($posts as $i => $post)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('agencia.posts.show', $post) }}" class="btn btn-xs btn-outline-info btn-sm">Ver</a>
                            <a href="{{ route('agencia.posts.edit', $post) }}" class="btn btn-xs btn-outline-primary btn-sm">Editar</a>
                            <form method="POST" action="{{ route('agencia.posts.destroy', $post) }}" class="d-inline" onsubmit="return confirm('¿Eliminar?')">
                                @csrf @method('DELETE')
