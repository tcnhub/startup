                ...
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            ...
                            <div class="card-body peity-charts peity-chart-primary"><span
                                    class="line">5,3,9,6,5,9,7,3,5,2</span></div>
                        </div>
                    </div>
                    <div class="col-xl-4">
                        <div class="card">
                    ...
                    <div class="col-xl-4 box-col-6">
                        <div class="card">
                            ...
                            <div class="card-body peity-charts bar-odd-even"><span
                                    class="bar">5,3,9,6,5,9,7,3,5,2</span></div>
                        </div>
                    </div>
                    <div class="col-xl-4 box-col-6">
                        <div class="card">
                            ...
                            <div class="card-body peity-charts bar-odd-even"><span
                                    class="bar">5,3,2,-1,-3,-2,2,3,5,2</span></div>
                        </div>
                    </div>
                    <div class="col-xl-4 box-col-6">
                        <div class="card">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="data-attributes"><span class="small-donut"
                                        ...
                                        class="small-donut6"
                                        data-peity="{&quot;innerRadius&quot;: 18, &quot;radius&quot;: 20 }">6/7</span>
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-3 text-center col-6">
                                        <div class="xm-mb-peity"><span class="bar-colours-1">5,3,9,6,5,9,7,3,5,2</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-3 text-center col-6">
                                        <div class="xm-mb-peity"><span
                                                class="bar-colours-2">5,3,2,-1,-3,-2,2,3,5,2</span></div>
                                    </div>
                                    <div class="col-sm-3 text-center col-6"><span
                                            class="bar-colours-3">0,-3,-6,-4,-5,-4,-7,-3,-5,-2</span></div>
                                    <div class="col-sm-3 text-center col-6"><span class="pie-colours-1">4,7,6,5</span>
                                    </div>
                                </div>
                            </div>
                        </div>
