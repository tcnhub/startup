...
class PostController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('guia.posts.index', compact('posts', 'perPage', 'search'));
    }

    public function create()
    {
        return view('guia.posts.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('guia.posts.index')
    ...
    public function show(Post $post)
    {
        ...
        return view('guia.posts.show', compact('post'));
    }

    public function edit(Post $post)
    {
        $this->authorizePost($post);
        return view('guia.posts.edit', compact('post'));
    }
