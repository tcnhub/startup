...
class PostController extends Controller
{
    ...
    {
        return Auth::guard('actividad')->user();
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('actividad.posts.index', compact('posts', 'perPage', 'search'));
    }

    public function create()
    {
        return view('actividad.posts.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('actividad.posts.index')
    ...
    public function show(Post $post)
    {
        ...
        return view('actividad.posts.show', compact('post'));
    }

    public function edit(Post $post)
    {
        $this->authorizePost($post);
        return view('actividad.posts.edit', compact('post'));
    }
