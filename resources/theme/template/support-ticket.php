                                ...
                                <div class="table-responsive">
                                    <table class="display" id="basic-6">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media"><img class="rounded-circle img-30 me-3" src="assets/images/user/10.jpg" alt="Generic placeholder image">
                                                        <div class="media-body align-self-center">
                                                            <div>Sonya Frost</div>
                                                        </div>
                                                    </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media"><img class="rounded-circle img-30 me-3" src="assets/images/user/12.png" alt="Generic placeholder image">
                                                        <div class="media-body align-self-center">
                                                            <div>Quinn Flynn</div>
                                                        </div>
                                                    </div>
