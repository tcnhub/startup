                                    ...
                                    <div class="job-description">
                                        ...
                                        <form class="form theme-form">
                                                ...
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <label class="form-label"
                                                            for="exampleFormControlInput3">Email:<span
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <label class="form-label"
                                                            for="exampleFormControlpassword">Password:<span
                                                                class="font-danger">*</span></label>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <label class="form-label"
                                                            for="exampleFormControlpassword1">Repeat Password:<span
                                                                class="font-danger">*</span></label>
                                                ...
                                                <div class="col">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" id="exampleFormControlInput4"
                                                            type="email" placeholder="Enter Phone no.">
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                                ...
                                                <div class="col-xl-6 xl-100">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" id="exampleFormControlInput5"
                                                            type="email" placeholder="Enter college name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-6 xl-100">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" id="exampleFormControlInput6"
                                                            type="email" placeholder="Enter specialization">
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                        ...
                                        <form class="form theme-form">
                                            <div class="row">
                                                <div class="col-xl-6 xl-100">
                                                    <div class="mb-3">
                                                        <label class="form-label"
                                                            for="exampleFormControlInput7">Location:<span
                                                                class="font-danger">*</span></label>
                                                        <input class="form-control" id="exampleFormControlInput7"
                                                            type="email" placeholder="Enter Location">
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 xl-100 xl-mt-job">
                                                    <label class="col-form-label text-end pt-0">Period:<span
                                                ...
                                                <div class="col-xl-6 xl-100">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" id="exampleFormControlInput8"
                                                            type="email" placeholder="Enter Company Name">
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                        ...
                                        <form class="form theme-form">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div>
                                                        <label class="col-form-label pt-0">Upload
