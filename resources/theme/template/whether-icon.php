                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row icon-lists whether-icon">
                                    ...
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_moon" id="moon" version="1.1"
                                            viewBox="15 15 70 70">
                                    ...
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudDrizzleFill" id="cloudDrizzleFill"
                                    ...
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudDrizzleSun" id="cloudDrizzleSun"
                                            version="1.1" viewBox="15 15 70 70">
                                    ...
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudDrizzleMoon" id="cloudDrizzleMoon"
                                            version="1.1" viewBox="15 15 70 70">
                                    ...
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudDrizzleAlt" id="cloudDrizzleAlt"
                                            version="1.1" viewBox="15 15 70 70">
                                    ...
                                    <!-- cloudDrizzleSunAlt-->
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudDrizzleSunFillAlt"
                                            id="cloudDrizzleSunFillAlt" version="1.1" viewBox="15 15 70 70">
                                    ...
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudDrizzleMoonFillAlt"
                                            id="cloudDrizzleMoonFillAlt" version="1.1" viewBox="15 15 70 70">
                                    ...
                                    <!-- cloudRainSun-->
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudRainSunFill" id="cloudRainSunFill"
                                            version="1.1" viewBox="15 15 70 70">
                                    ...
                                    <!-- cloudRainAlt-->
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudRainAltFill" id="cloudRainAltFill"
                                            version="1.1" viewBox="15 15 70 70">
                                    ...
                                    <!-- cloudRainAlt-->
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudSunRainAlt" id="cloudRainSunAlt"
                                            version="1.1" viewBox="15 15 70 70">
                                    ...
                                    <!-- cloudRainSunAltFill-->
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudMoonRainAlt" id="cloudRainMoonAlt"
                                            version="1.1" viewBox="15 15 70 70">
                                    ...
                                    <!-- cloudHailAlt-->
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudHailAltFill" id="cloudHailAltFill"
                                            version="1.1" viewBox="15 15 70 70">
                                    ...
                                    <!-- cloudHailAltFill-->
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudHailAltSun" id="cloudHailAltSun"
                                            version="1.1" viewBox="15 15 70 70">
                                    ...
                                    <!-- cloudHailAltSun-->
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudHailAltMoon" id="cloudHailAltMoon"
                                            version="1.1" viewBox="15 15 70 70">
                                    ...
                                    <!-- cloudSnowAltFill-->
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudSnowSunAlt" id="cloudSnowSunAlt"
                                            version="1.1" viewBox="15 15 70 70">
                                    ...
                                    <!-- cloudFogSun-->
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudFogSunFill" id="cloudFogSunFill"
                                            version="1.1" viewBox="15 15 70 70">
                                    ...
                                    <!-- cloudFogAlt-->
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudFogAltFill" id="cloudFogAltFill"
                                            version="1.1" viewBox="15 15 70 70">
                                    ...
                                    <!-- cloudFogSunAltFill-->
                                    <div class="col-lg-2 col-3">
                                        <svg class="climacon climacon_cloudFogMoonAlt" id="cloudFogMoonAlt"
                                            version="1.1" viewBox="15 15 70 70">
                                        ...
                                        <svg class="climacon climacon_sunrise" id="sunrise" version="1.1"
                                            ...
                                            <g class="climacon_iconWrap climacon_iconWrap-sunrise">
                                                <g class="climacon_componentWrap climacon_componentWrap-sunrise">
                                                    ...
                                                    <g
                                                        class="climacon_wrapperComponent climacon_wrapperComponent-arrow">
                                                        <path
