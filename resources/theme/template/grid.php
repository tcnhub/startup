                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Grid Options</h5><span>Bootstrap grid allows building an equal height flexbile
                                    blocks easily</span>
                            </div>
                            <div class="card-body">
                                <p>While Bootstrap uses <code>em </code>or <code>rem </code>for defining most sizes,
                                    <code>px</code> are used for grid breakpoints and container widths. This is because
                                    the viewport width is in pixels and does not change with the <a href="#">font
                                        size</a>.</p>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body grid-showcase">
                                <p>Using a single set of <code>.col-md-*</code> grid classes, you can create a basic
                                    grid system that starts out stacked on mobile devices and tablet devices (the extra
                                    small to small range) before becoming horizontal on desktop (medium) devices. Place
                                    grid columns within any <code>.row</code>.</p>
                                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body grid-showcase">
                                <p>Use <code>.order-</code> classes for controlling the <strong>visual order</strong> of
                                    ...
                                    breakpoint (e.g., <code>.order-1.order-md-2</code>). Includes support for
                                    <code>1</code> through <code>12</code> across all five grid tiers.</p>
                                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body grid-showcase">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 offset-sm-2 col-md-6 offset-md-0"><span>.col-sm-5 .offset-sm-2
                                            .col-md-6 .offset-md-0</span></div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6 col-md-5 col-lg-6"><span>.col-sm-6 .col-md-5 .col-lg-6</span>
                                    </div>
                                    <div class="col-sm-6 col-md-5 offset-md-2 col-lg-6 offset-lg-0"><span>.col-sm-6
                                            .col-md-5 .offset-md-2 .col-lg-6 .offset-lg-0</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
