                                        ...
                                        <div class="email-app-sidebar left-bookmark">
                                            ...
                                            <ul class="nav main-menu contact-options" role="tablist">
                                                ...
                                                <li><a id="pills-personal-tab" data-bs-toggle="pill"
                                                        ...
                                                        aria-selected="true"><span class="title"> Personal</span></a>
                                                </li>
                                                <li>
                                        ...
                                        <div class="tab-content">
                                                                    ...
                                                                    role="tablist" aria-orientation="vertical"><a
                                                                        ...
                                                                        <div class="media"><img
                                                                            ...
                                                                            <div class="media-body">
                                                                                ...
                                                                                <p class="email_add_0">barnes@gmail.com
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="media"><img
                                                                            ...
                                                                            <div class="media-body">
                                                                                ...
                                                                                <p class="email_add_4">jasonb@gmail.com
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="media"><img
                                                                            ...
                                                                            <div class="media-body">
                                                                                ...
                                                                                <p class="email_add_5">monty@gmail.com
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-4 col-sm-6">
                                                                                        <select
                                                                                            ...
                                                                                            <option value="pw">Personal
                                                                                                web address</option>
                                                                                            <option value="cw">Company
                                                                                                web address</option>
                                                                                            <option value="fb">Fabebook
                                                                                                URL</option>
                                                            ...
                                                            <div class="col-xl-8 xl-50 col-md-7">
                                                                <div class="tab-content" id="v-pills-tabContent1">
                                                                    <div class="tab-pane fade show active"
                                                                        id="v-pills-iduser" role="tabpanel"
                                                                    ...
                                                                    <div class="tab-pane fade" id="v-pills-iduser3"
                                                                        ...
                                                                        <div class="profile-mail">
                                                                            <div class="media"><img
                                                                                ...
                                                                                <div class="media-body mt-0">
                                                                                    <h5> <span
                                                                                            class="first_name_8">Andew
                                                                                        </span><span
                                                                                            class="last_name_8">Jon</span>
                                                                                    </h5>
                                                                                    <p class="email_add_8">
                                                                                        andrewj@gmail.com</p>
                                                                                    <ul>
                                            ...
                                            <div id="right-history">
                                                <div class="modal-header p-l-20 p-r-20">
                                                    <h6 class="modal-title w-100">Contact History<span
                                                            class="pull-right"><a class="closehistory" href="#"><i
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body list-persons">
                                                            ...
                                                            <button class="btn btn-secondary" id="btnPrint"
                                                                type="button" onclick="printDiv();">Print</button>
                                                            <button class="btn btn-primary" type="button"
                                                                data-bs-dismiss="modal">Cancel</button>
                                                        </div>
                                                    </div>
