...
<div class="row mt-4">
    <div class="col-lg-8">
        <div class="card shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('restaurante.profile.edit') }}" class="btn btn-sm btn-outline-secondary">← Perfil</a>
            </div>
            <div class="card-body">
                <div class="row g-3">
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="card h-100">
                                ...
                                <div class="card-body p-2 text-center">
                                    <form method="POST" action="{{ route('restaurante.profile.gallery.delete', $photo) }}" onsubmit="return confirm('¿Eliminar foto?')">
                                        @csrf @method('DELETE')
    ...
    <div class="col-lg-4 mt-3 mt-lg-0">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('restaurante.profile.gallery.upload') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
