                      ...
                      <div class="col pr-xl-0 chat-right-aside">
                        ...
                        <div class="chat">
                          ...
                          <div class="chat-header clearfix"> 
                            <div class="media align-items-center">                         <img class="rounded-circle" src="assets/images/user/8.jpg" alt="">
                          ...
                          <div class="chat-history">
                            <div class="row">
                              ...
                              <div class="col-sm-7 ps-0 caller-img"><img class="img-fluid" src="assets/images/other-images/caller.jpg" alt=""></div>
                            </div>
                          </div>
                          <!-- chat-history ends-->
                          <!-- chat end-->
