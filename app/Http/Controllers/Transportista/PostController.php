...
class PostController extends Controller
{
    ...
    {
        return Auth::guard('transportista')->user();
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('transportista.posts.index', compact('posts', 'perPage', 'search'));
    }

    public function create()
    {
        return view('transportista.posts.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('transportista.posts.index')
    ...
    public function show(Post $post)
    {
        ...
        return view('transportista.posts.show', compact('post'));
    }

    public function edit(Post $post)
    {
        $this->authorizePost($post);
        return view('transportista.posts.edit', compact('post'));
    }
