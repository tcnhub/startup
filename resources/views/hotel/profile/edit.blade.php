    ...
    <div class="col-lg-4 mt-3 mt-lg-0">
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <a href="{{ route('hotel.profile.password') }}" class="btn btn-outline-warning btn-sm w-100 mb-2">Cambiar contraseña</a>
                <a href="{{ route('hotel.profile.gallery') }}" class="btn btn-outline-info btn-sm w-100">Galería de fotos</a>
            </div>
        </div>
    </div>
</div>
