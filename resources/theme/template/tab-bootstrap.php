                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
                                        ...
                                        <div class="dropdown-menu"><a class="dropdown-item" id="profile-tab"
                                                ...
                                                else here</a><a class="dropdown-item" href="#">Separated link</a></div>
                                    </li>
                                ...
                                <div class="tab-content" id="pills-icontabContent">
                                    <div class="tab-pane fade show active" id="pills-iconhome" role="tabpanel"
                                        ...
                                        <p class="mb-0 m-t-30">Lorem Ipsum is simply dummy text of the printing and
                                            ...
                                            Letraset sheets containing Lorem Ipsum passages, and more recently with
                                            desktop publishing software like Aldus PageMaker including versions of Lorem
                                            Ipsum.It was popularised in the 1960s with the release of Letraset sheets
                                            containing Lorem Ipsum passages, and more recently with desktop publishing
                                            software like Aldus PageMaker including versions of Lorem IpsumIt was
                                            popularised in the 1960s with the release of Letraset sheets containing
                                            Lorem Ipsum passages, and more recently with desktop publish It was
                                            popularised in the 1960s with the release of Letraset sheets containing
                                ...
                                <div class="tab-content" id="pills-darktabContent">
                                    <div class="tab-pane fade show active" id="pills-darkhome" role="tabpanel"
                                        ...
                                        <p class="mb-0 m-t-30">Lorem Ipsum is simply dummy text of the printing and
                                            ...
                                            Letraset sheets containing Lorem Ipsum passages, and more recently with
                                            desktop publishing software like Aldus PageMaker including versions of Lorem
                                            Ipsum in the 1960s with the release of Letraset sheets containing Lorem
                                            Ipsum passages,It has survived not only five</p>
                                    </div>
