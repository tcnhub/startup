...
<div class="card mt-4 shadow-sm">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('transportista.posts.create') }}" class="btn btn-primary btn-sm">+ Nuevo Post</a>
    </div>
    <div class="card-body">
            ...
            <table class="table table-hover align-middle">
                ...
                @forelse($posts as $i => $post)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('transportista.posts.show', $post) }}" class="btn btn-xs btn-outline-info btn-sm">Ver</a>
                            <a href="{{ route('transportista.posts.edit', $post) }}" class="btn btn-xs btn-outline-primary btn-sm">Editar</a>
                            <form method="POST" action="{{ route('transportista.posts.destroy', $post) }}" class="d-inline" onsubmit="return confirm('¿Eliminar?')">
                                @csrf @method('DELETE')
