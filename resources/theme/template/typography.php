            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Headings</h5><span>All HTML headings, <code>&lt;h1&gt;</code> through
                                    <code>&lt;h6&gt;</code>, are available.</span>
                            </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Headings</h5><span>Use the included utility classes to recreate the small secondary
                                    heading text. </span>
                            </div>
                            <div class="card-body typography">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Display headings</h5><span>Traditional heading elements are designed to work best in
                                    the meat of your page content. When you need a heading to stand out, consider using
                                    a <strong>display heading</strong>—a larger, slightly more opinionated heading
                                    style.</span>
                            </div>
                            <div class="card-body typography">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="txt-primary">This is Primary text You can archive this adding
                                    <code>.txt-primary</code> class</p>
                                <p class="txt-secondary">This is Secondary text You can archive this adding
                                    <code>.txt-secondary</code> class</p>
                                <p class="txt-success">This is Success text You can archive this adding
                                    <code>.txt-success</code> class</p>
                                <p class="txt-info">This is Info text You can archive this adding <code>.txt-info</code>
                                    class</p>
                                <p class="txt-warning">This is Warning text You can archive this adding
                                    <code>.txt-warning</code> class</p>
                                <p class="txt-danger">This is Danger text You can archive this adding
                                    <code>.txt-danger</code> class</p>
                                <p class="txt-dark">This is Dark text You can archive this adding <code>.txt-dark</code>
                                    class</p>
                                <p class="txt-primary">This is Primary text You can archive this adding
                                    <code>.txt-primary</code> class</p>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-xl-4">
                                        ...
                                        <ul>
                                            <li><i class="fa fa-angle-double-right txt-primary m-r-10"></i>Lorem ipsum
                                                dolor sit amet</li>
                                            <li><i class="fa fa-angle-double-right txt-primary m-r-10"></i>Lorem ipsum
                                                dolor sit amet</li>
                                            <li><i class="fa fa-angle-double-right txt-primary m-r-10"></i>Lorem ipsum
                                    ...
                                    <div class="col-sm-12 col-xl-4">
                                        ...
                                        <ul>
                                            <li><i class="fa fa-caret-right txt-secondary m-r-10"></i>Lorem ipsum dolor
                                                sit amet</li>
                                            <li><i class="fa fa-caret-right txt-secondary m-r-10"></i>Lorem ipsum dolor
                                                sit amet</li>
                                            <li><i class="fa fa-caret-right txt-secondary m-r-10"></i>Lorem ipsum dolor
                                    ...
                                    <div class="col-sm-12 col-xl-4">
                                        ...
                                        <ul>
                                            <li><i class="icofont icofont-ui-rate-add txt-success m-r-10"></i>Lorem
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Blockquotes</h5><span>Add a <code>&lt;footer class="blockquote-footer"&gt;</code>
