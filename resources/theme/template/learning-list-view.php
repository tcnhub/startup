                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="blog-box blog-list row">
                                        <div class="col-sm-5"><img class="img-fluid sm-100-w"
                                                src="assets/images/faq/1.jpg" alt=""></div>
                                        <div class="col-sm-7">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="blog-box blog-list row">
                                        <div class="col-sm-5"><img class="img-fluid sm-100-w"
                                                src="assets/images/faq/2.jpg" alt=""></div>
                                        <div class="col-sm-7">
                                            <div class="blog-details">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="collapse show" id="collapseicon" aria-labelledby="collapseicon"
                                            ...
                                            <div class="card-body filter-cards-view animate-chk">
                                                ...
                                                <div class="checkbox-animated mt-0">
                                                    <div class="learning-header"><span class="f-w-600">Price</span>
                                                    </div>
                                                ...
                                                <div class="checkbox-animated mt-0">
                                                    <div class="learning-header"><span class="f-w-600">Status</span>
                                                    </div>
                                                ...
                                                <div class="media">
                                                    <div class="media-body"><span class="f-w-600">UX
                                                            Development</span><span class="d-block">Course By <a
                                                                href="#"> Lorem ipsum</a></span><span class="d-block"><i
