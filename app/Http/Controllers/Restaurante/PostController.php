...
class PostController extends Controller
{
    ...
    {
        return Auth::guard('restaurante')->user();
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('restaurante.posts.index', compact('posts', 'perPage', 'search'));
    }

    public function create()
    {
        return view('restaurante.posts.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('restaurante.posts.index')
    ...
    public function show(Post $post)
    {
        ...
        return view('restaurante.posts.show', compact('post'));
    }

    public function edit(Post $post)
    {
        $this->authorizePost($post);
        return view('restaurante.posts.edit', compact('post'));
    }
