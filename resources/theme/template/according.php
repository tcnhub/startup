            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                <h5>Basic Accordion</h5><span>Using the <a href="#">card</a> component, you can extend
                                    the default collapse behavior to create an accordion.</span>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                <h5>All Close Accordion</h5><span>Using the <a href="#">card</a> component, you can
                                        ...
                                        <div class="card-header" id="heading1">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="heading1">Collapsible Group Item
                                                    #<span>1</span></button>
                                            </h5>
                                        </div>
                                        ...
                                        <div class="card-header" id="heading2">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link collapsed" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="heading2">Collapsible Group Item
                                                    #<span>2</span></button>
                                            </h5>
                                        </div>
                                        ...
                                        <div class="card-header" id="heading3">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link collapsed" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="collapse3">Collapsible Group Item
                                                    #<span>3</span></button>
                                            </h5>
                                        </div>
                                        ...
                                        <div class="card-header" id="heading4">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link collapsed" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="collapse4">Collapsible Group Item
                                                    #<span>4</span></button>
                                            </h5>
                                        </div>
                                        ...
                                        <div class="card-header" id="heading5">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link collapsed" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="collapse5">Collapsible Group Item
                                                    #<span>5</span></button>
                                            </h5>
                                        </div>
                                        ...
                                        <div class="card-header bg-primary" id="headingFour">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link text-white" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="collapseFour">Collapsible Group Item
                                                    #<span>1</span></button>
                                            </h5>
                                        </div>
                                        ...
                                        <div class="card-header bg-primary" id="headingFive">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link collapsed text-white"
                                                    ...
                                                    aria-expanded="false" aria-controls="collapseFive">Collapsible Group
                                                    Item #<span>2</span></button>
                                            </h5>
                                        </div>
                                        ...
                                        <div class="card-header bg-primary" id="headingSix">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link collapsed text-white"
                                                    ...
                                                    aria-expanded="false" aria-controls="collapseSix">Collapsible Group
                                                    Item #<span>3</span></button>
                                            </h5>
                                        </div>
                                ...
                                <div class="default-according" id="accordion2">
                                    <div class="card">
                                        <div class="card-header bg-secondary" id="headingseven">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link text-white" data-bs-toggle="collapse"
                                                    data-bs-target="#collapseseven" aria-expanded="true">Collapsible
                                                    Group Item #<span>1</span></button>
                                            </h5>
                                        </div>
                                        ...
                                        <div class="card-header bg-secondary" id="headingeight">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link collapsed text-white"
                                                    ...
                                                    aria-expanded="false" aria-controls="collapseeight">Collapsible
                                        ...
                                        <div class="card-header bg-secondary" id="headingnine">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link collapsed text-white"
                                                    ...
                                                    aria-expanded="false" aria-controls="collapsenine">Collapsible Group
                                                    Item #<span>3</span></button>
                                            </h5>
                                        </div>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                <h5>Accordion With Icon on Title</h5><span>Add <code>&lt;i&gt;&lt;/i&gt;</code> tag
                                    Along with icon class before title text.</span>
                            </div>
                            <div class="card-body">
                                            ...
                                            <h5 class="mb-0">
                                                <button class="btn btn-link text-white" data-bs-toggle="collapse"
                                                    ...
                                                    aria-controls="collapse11"><i
                                                        class="icofont icofont-briefcase-alt-2"></i>Collapsible Group
                                                    Item #<span>1</span></button>
                                            </h5>
                                        </div>
                                        ...
                                        <div class="card-header bg-primary" id="heading22">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link collapsed text-white"
                                                    ...
                                                    aria-expanded="false" aria-controls="collapse22"><i
                                        ...
                                        <div class="card-header bg-primary" id="heading33">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link collapsed text-white"
                                                    ...
                                                    aria-expanded="false" aria-controls="collapse44"><i
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                <h5>Accordion open close icon</h5><span>Add <code>&lt;i&gt;&lt;/i&gt;</code> tag Along
                                    with icon class before title text.</span>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="card-header bg-primary">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link collapsed text-white"
                                                    ...
                                                    aria-expanded="false"><i class="icofont icofont-support"></i>
                                                    Collapsible Group Item #<span>2</span></button>
                                            </h5>
                                        </div>
                                        ...
                                        <div class="card-header bg-primary">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link collapsed text-white"
                                                    ...
                                                    aria-expanded="false" aria-controls="collapseicon2"><i
                                                        class="icofont icofont-tasks-alt"></i> Collapsible Group Item
                                                    #<span>3</span></button>
                                            </h5>
                                        </div>
