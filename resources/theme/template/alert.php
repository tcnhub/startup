            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                <h5>Theme Color Alerts</h5><span>Theme color Archive just adding class
                                    <code>.dark</code></span>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                <h5>Link color in theme-color</h5><span>Use the <code>.alert-link</code> utility class
                                    to quickly provide matching colored links within any alert</span>
                            </div>
                            <div class="card-body">
                                <div class="alert alert-primary dark" role="alert">
                                    <p>This is a primary alert with <a class="alert-link" href="#">an example
                                            link</a>.Click It</p>
                                </div>
                                <div class="alert alert-secondary dark" role="alert">
                                    <p>This is a secondary alert with <a class="alert-link" href="#">an example
                                            link</a>.Click It</p>
                                </div>
                                <div class="alert alert-success dark" role="alert">
                                    <p>This is a success alert with <a class="alert-link" href="#">an example
                                            link</a>.Click It</p>
                                </div>
                                <div class="alert alert-info dark" role="alert">
                                    <p>This is a info alert with <a class="alert-link" href="#">an example
                                            link</a>.Click It</p>
                                </div>
                                <div class="alert alert-warning dark" role="alert">
                                    <p>This is a warning alert with <a class="alert-link" href="#">an example
                                            link</a>.Click It</p>
                                </div>
                                <div class="alert alert-danger dark" role="alert">
                                    <p>This is a danger alert with <a class="alert-link" href="#">an example
                                            link</a>.Click It</p>
                                </div>
                                <div class="alert alert-light dark" role="alert">
                                    <p>This is a light alert with <a class="alert-link" href="#">an example
                                            link</a>.Click It</p>
                                </div>
                                <div class="alert alert-dark dark" role="alert">
                                    <p>This is a light alert with <a class="alert-link" href="#">an example
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="card height-equal">
                            <div class="card-header">
                                <h5>Dismissing</h5><span>To animate alerts when dismissing them, be sure to add the
                                    .fade and .show classes.</span>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                <h5>Light Alerts</h5><span>Alerts are available for any length of text, as well as an
                                    optional dismiss button.</span>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                <h5>Link color</h5><span>Use the <code>.alert-link</code> utility class to quickly
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="card height-equal">
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-info alert-dismissible fade show" role="alert"><strong>Holy
                                        !</strong> You can check in on some of those fields below.
                                    <button class="btn-close" type="button" data-bs-dismiss="alert"
                                        aria-label="Close"></button>
                                </div>
                                ...
                                <div class="alert alert-danger alert-dismissible fade show" role="alert"><strong>Holy
                                        !</strong> You can check in on some of those fields below.
                                    <button class="btn-close" type="button" data-bs-dismiss="alert"
                                        aria-label="Close"></button>
                                </div>
                                <div class="alert alert-light alert-dismissible fade show" role="alert"><strong>Holy
                                        !</strong> You can check in on some of those fields below.
                                    <button class="btn-close" type="button" data-bs-dismiss="alert"
                                        aria-label="Close"></button>
                                </div>
                                <div class="alert alert-dark alert-dismissible fade show" role="alert"><strong>Holy
                                        !</strong> You can check in on some of those fields below.
                                    <button class="btn-close" type="button" data-bs-dismiss="alert"
                                        aria-label="Close"></button>
                                </div>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="card height-equal">
                            <div class="card-header">
                                <h5>Outline Alerts</h5><span>Outline Archive just adding class
                                    <code>.outline</code></span>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="card height-equal">
                            <div class="card-header">
                                <h5>Outline Dark Alerts</h5><span>Outline Archive just adding class
                                    <code>.outline-2x</code></span>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                <h5>Alert With Icon inverse</h5><span>Use the <code>.inverse</code> class to quickly
                                    provide matching colored links within any alert</span>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                <h5>Text as action</h5><span>Use the <code>.action-text</code> class to add dismiss text
                            ...
                            <div class="card-body dismiss-text">
                                <div class="alert alert-primary inverse alert-dismissible fade show" role="alert"><i
                                    ...
                                    <p>Your time Over after <b>5</b> miniute</p>
                                    <button class="btn-close" type="button" data-bs-dismiss="alert"
                                        aria-label="Close"><span class="bg-primary"
                                ...
                                <div class="alert alert-secondary inverse alert-dismissible fade show" role="alert"><i
                                    ...
                                    <p>Oh snap! Change a few things up and submit again.</p>
                                    <button class="btn-close" type="button" data-bs-dismiss="alert"
                                        aria-label="Close"><span class="bg-secondary"
                                            aria-hidden="true">dismiss</span></button>
                                </div>
                                <div class="alert alert-success inverse alert-dismissible fade show" role="alert"><i
                                        class="icon-thumb-up alert-center"></i>
                                    <p><b> Well done! </b>You successfully read this important alert message.</p>
                                    <button class="btn-close" type="button" data-bs-dismiss="alert"
                                        aria-label="Close"><span class="bg-success"
                                            aria-hidden="true">dismiss</span></button>
                                </div>
                                <div class="alert alert-info inverse alert-dismissible fade show" role="alert"><i
                                        class="icon-help-alt"></i>
                                    <p><b>welcome!</b> Start your day with some alerts.</p>
                                    <button class="btn-close" type="button" data-bs-dismiss="alert"
                                        aria-label="Close"><span class="bg-info"
                                            aria-hidden="true">dismiss</span></button>
                                </div>
                                <div class="alert alert-warning inverse alert-dismissible fade show" role="alert"><i
                                        class="icon-bell"></i>
                                    <p><b> Congratulation! </b>Your Product Added in Like List</p>
                                    <button class="btn-close" type="button" data-bs-dismiss="alert"
                                        aria-label="Close"><span class="bg-warning"
                                            aria-hidden="true">dismiss</span></button>
                                </div>
                                <div class="alert alert-danger inverse alert-dismissible fade show" role="alert"><i
                                        class="icon-thumb-down"></i>
                                    <p>Your <b> Perfomance </b> is down on this week</p>
                                    <button class="btn-close" type="button" data-bs-dismiss="alert"
                                        aria-label="Close"><span class="bg-danger"
                                            aria-hidden="true">dismiss</span></button>
                                </div>
                                <div class="alert alert-light inverse alert-dismissible fade show" role="alert"><i
                                        class="icon-alert txt-dark"></i>
                                    <p>You can check in on some of those fields below.</p>
                                    <button class="btn-close" type="button" data-bs-dismiss="alert"
                                        aria-label="Close"><span class="bg-light txt-dark"
                                            aria-hidden="true">dismiss</span></button>
                                </div>
                                <div class="alert alert-dark inverse alert-dismissible fade show" role="alert"><i
                                        class="icon-info-alt"></i>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Additional content</h5><span>Alerts can also contain additional HTML elements like
                                    headings, paragraphs and dividers.</span>
                            </div>
                            <div class="card-body">
                                <div class="alert alert-primary" role="alert">
