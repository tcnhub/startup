                                ...
                                <div class="text-center">
                                    <ul class="nav nav-tabs search-list" id="top-tab" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" id="all-link"
                                                ...
                                                aria-selected="true"><i class="icon-target"></i>All</a></li>
                                        ...
                                        <li class="nav-item bg-light-success"><a class="nav-link txt-success"
                                                id="setting-link" data-bs-toggle="tab" href="#setting-links" role="tab"
                                                aria-selected="false">Settings</a></li>
                                        <li class="nav-item bg-light-secondary"><a class="nav-link txt-secondary"
                                        ...
                                        <div class="row">
                                            <div class="col-xxl-8 col-xl-6 box-col-12">
                                                ...
                                                <div class="info-block"><a
                                                    ...
                                                    <p>2020's Best Selling Creative WP Themes. The #1 Source of Premium
                                                        WP Themes! ThemeForest 45,000+ WP Themes & Website Templates
                                                        From $2. Check it Out! </p>
                                                ...
                                                <div class="info-block"><a href="">PixelStrap - Portfolio |
                                                    ...
                                                    <p>The #1 marketplace for premium website templates, including
                                                        themes for WordPress, Magento, Drupal, Joomla, and more. Create
                                                        a website, fast.</p>
                                                    <div class="star-ratings">
                                                        <ul class="search-info">
                                                            <li>3 stars</li>
                                                ...
                                                <div class="info-block"><a
                                                    ...
                                                    <p>Cuba introduces a IELTS Coaching, TOEFL Coaching, GRE Coaching,
                                                        GMAT Coaching, SAT Coaching in Surat.</p>
                                                    <div class="star-ratings">
                                                        <ul class="search-info">
                                            ...
                                            <div class="col-xxl-4 col-xl-6 box-col-12 mt-4">
                                                <div class="card lg-mt o-hidden">
                                                    <div class="blog-box blog-shadow"><img class="img-fluid"
                                                            src="assets/images/blog/blog.jpg" alt="">
                                                        <div class="blog-details">
                                                            <p>25 July 2018</p>
                                                            <h4>Accusamus et iusto odio dignissimos ducimus qui
                                                                blanditiis.</h4>
                                                ...
                                                <div class="info-block"><a
                                                    ...
                                                    <p>Get 59 pixelstrap website templates on ThemeForest. Buy
                                                        pixelstrap website templates from $7. All created by our Global
                                                        Community of independent Web ...</p>
                                                    <div class="star-ratings">
                                                        <ul class="search-info">
                                                            <li><i class="icofont icofont-ui-rating"></i><i
                                                                    class="icofont icofont-ui-rating"></i><i
                                    ...
                                    <div class="tab-pane fade" id="image-links" role="tabpanel"
                                        ...
                                        <div>
                                            ...
                                            <div class="my-gallery row gallery-with-description"
                                                id="aniimated-thumbnials" itemscope="">
                                                <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia"
                                                    itemscope=""><a href="assets/images/big-lightgallry/01.jpg"
                                                ...
                                                <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia"
                                                    itemscope=""><a href="assets/images/big-lightgallry/02.jpg"
                                                        itemprop="contentUrl" data-size="1600x950"><img
                                                ...
                                                <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia"
                                                    itemscope=""><a href="assets/images/big-lightgallry/03.jpg"
                                                        itemprop="contentUrl" data-size="1600x950"><img
                                                ...
                                                <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia"
                                                    itemscope=""><a href="assets/images/big-lightgallry/04.jpg"
                                                        itemprop="contentUrl" data-size="1600x950"><img
                                                ...
                                                <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia"
                                                    itemscope=""><a href="assets/images/big-lightgallry/05.jpg"
                                                        itemprop="contentUrl" data-size="1600x950"><img
