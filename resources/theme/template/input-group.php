                                    ...
                                    <div class="col">
                                        <form>
                                            ...
                                            <div class="mb-3 input-group-square">
                                                ...
                                                <div class="input-group input-group-air"><span
                                    ...
                                    <div class="col">
                                        <form>
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control" type="text"
                                                        ...
                                                        class="input-group-text"><i
                                                            class="icofont icofont-ui-dial-phone"> </i></span>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Joint Addon</label>
                                            ...
                                            <div>
                                                <label class="form-label">Left & Right Addon</label>
                                                <div class="input-group pill-input-group"><span
                                                        class="input-group-text"><i class="icofont icofont-ui-copy">
                                                        </i></span>
                                                    <input class="form-control" type="text"
                                                        aria-label="Amount (to the nearest dollar)"><span
                                                        class="input-group-text"><i
                                                            class="icofont icofont-stock-search"> </i></span>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
