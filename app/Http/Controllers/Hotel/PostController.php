...
class PostController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('hotel.posts.index', compact('posts', 'perPage', 'search'));
    }

    public function create()
    {
        return view('hotel.posts.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('hotel.posts.index')
    ...
    public function show(Post $post)
    {
        ...
        return view('hotel.posts.show', compact('post'));
    }

    public function edit(Post $post)
    {
        $this->authorizePost($post);
        return view('hotel.posts.edit', compact('post'));
    }
