                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p>This <a class="btn btn-primary popover-test" href="#" role="button"
                                                        ...
                                                        data-original-title="Popover title">button</a> triggers a
                                                    popover on click.</p>
                                                <hr>
                                            ...
                                            <div class="modal-body grid-showcase">
                                                <div class="container-fluid bd-example-row">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 ml-auto"><span>.col-md-4 .ml-auto</span>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-3 ml-auto"><span>.col-md-3 .ml-auto</span>
                                                        </div>
                                                        <div class="col-md-2 ml-auto"><span>.col-md-2 .ml-auto</span>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6 ml-auto"><span>.col-md-6 .ml-auto</span>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body btn-showcase">
                                ...
                                <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                                    data-bs-target="#exampleModalgetbootstrap" data-whatever="@getbootstrap">Open modal
