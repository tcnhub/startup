                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body"><a class="badge badge-primary" href="#">1</a><a
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body"><a class="badge badge-primary" href="#"><i
                                        data-feather="dollar-sign"></i></a><a class="badge badge-secondary" href="#"><i
                                        data-feather="headphones"></i></a><a class="badge badge-success" href="#"><i
                                        data-feather="link"></i></a><a class="badge badge-info" href="#"><i
                                        data-feather="github"></i></a><a class="badge badge-warning text-dark"
                                    href="#"><i data-feather="award"></i></a><a class="badge badge-danger" href="#"><i
                                        data-feather="activity"></i></a><a class="badge badge-light text-dark"
                                    href="#"><i data-feather="heart"></i></a><a class="badge badge-dark" href="#"><i
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body"><a class="badge rounded-pill badge-primary" href="#"><i
                                        data-feather="dollar-sign"></i></a><a class="badge rounded-pill badge-secondary"
                                    href="#"><i data-feather="headphones"></i></a><a
                                    class="badge rounded-pill badge-success" href="#"><i data-feather="link"></i></a><a
                                    class="badge rounded-pill badge-info" href="#"><i data-feather="github"></i></a><a
                                    class="badge rounded-pill badge-warning text-dark" href="#"><i
                                        data-feather="award"></i></a><a class="badge rounded-pill badge-danger"
                                    href="#"><i data-feather="activity"></i></a><a
                                    class="badge rounded-pill badge-light text-dark" href="#"><i
