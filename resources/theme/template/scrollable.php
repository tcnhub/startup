        ...
        <div class="row">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="scroll-bar-wrap">
                  <div class="click-drag-handler scroll-demo p-0"><img src="assets/images/banner/2.jpg" alt="" width="800" height="600"></div>
                </div>
              </div>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="card">
              ...
              <div class="card-body">
                <div class="scroll-bar-wrap">
                  <div class="scrollbar-margins large-margin scroll-demo p-0"><img src="assets/images/banner/3.jpg" alt="girl" width="800" height="600"></div>
                </div>
              </div>
            </div>
          </div>
