                                        ...
                                        <div class="email-app-sidebar left-bookmark task-sidebar">
                                            ...
                                            <ul class="nav main-menu" role="tablist">
                                                ...
                                                <li><a id="pills-created-tab" data-bs-toggle="pill"
                                                        ...
                                                        aria-selected="true"><span class="title"> Created by
                                                            me</span></a></li>
                                                ...
                                                <li><a class="show" id="pills-assigned-tab" data-bs-toggle="pill"
                                                        ...
                                                        aria-selected="false"><span class="title">Assigned to
                                                            me</span></a></li>
                                                ...
                                                <li><a class="show" id="pills-business-tab" data-bs-toggle="pill"
                                                        href="#" role="tab" aria-selected="false"><span class="title">
                                                            Business</span></a></li>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade active show" id="pills-created" role="tabpanel"
                                                ...
                                                <div class="card mb-0">
                                                    <div class="card-header d-flex">
                                                        <h5 class="mb-0">Created by me</h5><a href="#"><i class="me-2"
                                                        ...
                                                        <div class="taskadd">
                                                            <div class="table-responsive">
                                                                <table class="table">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <h6 class="task_title_0">Email newsletter
                                                                            </h6>
                                                                            <p class="project_name_0">General</p>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <h6 class="task_title_0">Publish podcast
                                                                            </h6>
                                                                            <p class="project_name_0">General</p>
                                                                        </td>
                                                                        <td>
                                                ...
                                                <div class="card mb-0">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="details-bookmark text-center">
                                                            ...
                                                            <div class="no-favourite"><span>No task due today.</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="fade tab-pane" id="pills-delayed" role="tabpanel"
                                                ...
                                                <div class="card mb-0">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="details-bookmark text-center"><span>No tasks
                                                                found.</span></div>
                                                    </div>
                                                </div>
                                            </div>
